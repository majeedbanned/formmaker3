          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-300 rounded-lg p-4">
            ...
            <div className="mt-4 pt-4 border-t border-blue-200">
              ...
              <p className="text-xs text-gray-600 mb-3">
                یک پاسخنامه 120 سوالی را با پاسخ‌های صحیح پر کنید و آپلود کنید تا تمام کلیدها به صورت خودکار استخراج شوند.
                <br />
                <span className="font-semibold text-green-700">💡 نکته:</span> فقط سوالاتی که علامت زده‌اید استخراج می‌شوند. حتما از پاسخنامه 120 سوالی استفاده کنید.
              </p>
              <input
                type="file"
                id="answerKeyUpload"
