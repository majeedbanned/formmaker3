      ...
      try {
        ...
        return NextResponse.json({
          ...
          stats: {
            ...
            dateBegin: meetingInfo.dateBegin,
            dateEnd: meetingInfo.dateEnd,
            dateCreated: meetingInfo.dateCreated,
            dateModified: meetingInfo.dateModified,
            urlPath: meetingInfo.urlPath,
