  ...
  try {
    ...
    if (!footer) {
      ...
      const defaultFooter: FooterData = {
        ...
        logoText: "پ",
        companyDescription: "با سامانه پارساموز، مدیریت آموزشی مدرسه خود را به سطح جدیدی ارتقا دهید. ما اینجا هستیم تا تجربه کاربری بی‌نظیری را برای شما فراهم کنیم.",
        linkGroups: [
          {
            title: "محصولات",
            links: [
        ...
        newsletterDescription: "برای دریافت آخرین اخبار و بروزرسانی‌ها در خبرنامه ما عضو شوید.",
