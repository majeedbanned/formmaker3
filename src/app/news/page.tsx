...
const defaultNewsContent: NewsContent = {
  ...
  description: "از آخرین تحولات، رویدادها و بروزرسانی‌های   مطلع شوید.",
  news: [
    {
      id: 1,
    ...
    {
      id: 3,
      title: "همکاری   با وزارت آموزش و پرورش",
      excerpt:
        "تفاهم‌نامه همکاری میان    وزارت آموزش و پرورش جهت توسعه سیستم‌های نوین آموزشی به امضا رسید.",
      date: "۵ مرداد ۱۴۰۳",
      category: "همکاری‌ها",
      image:
