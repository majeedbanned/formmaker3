...
{ label: "طراحي و دوخت", value: "21220" },
{ label: "حسابداري مالي", value: "94203" },

{ label: "خیاطی لباس شب و عروس", value: "93154" },
{ label: "مدیریت و برنامه ریزی امور خانواده", value: "94101" },
  
        { label: "پويانمايي (انيميشن)", value: "21130" },
        { label: "تربيت كودك", value: "92210" },
        ...
        { label: "تولید و توسعه دهنده پایگاه های اینترنتی", value: "91125" },
        { label: "کابینت سازی چوبی", value: "91226" },
