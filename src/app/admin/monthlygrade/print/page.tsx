...
import MonthlyGradePrintView from "./components/MonthlyGradePrintView";

export default function MonthlyGradePrintPage() {
  ...
  useEffect(() => {
    ...
    const storedData = sessionStorage.getItem("monthlyGradePrintData");
    ...
    if (!storedData) {
      ...
      setTimeout(() => {
        router.push("/admin/monthlygrade");
      }, 2000);
      return;
    }
    ...
    try {
      ...
      sessionStorage.removeItem("monthlyGradePrintData");
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center p-8 text-gray-500">
          ...
          <button
            onClick={() => router.push("/admin/monthlygrade")}
  ...
  return (
    <>
      ...
      `}</style>
      <MonthlyGradePrintView {...printData} />
    </>
  );
}
