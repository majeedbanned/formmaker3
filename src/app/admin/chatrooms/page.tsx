...
function StudentsPageContent() {
  ...
  const pageTitle = () => {
    if (user?.userType === "student") {
      return "گفتگو با معلمان";
    } else if (user?.userType === "teacher") {
      return "گفتگو با کلاس ها";
    } else {
      return "گفتگو";
    }
  };
        ...
        {user?.userType === "teacher" && (
          <div className="bg-blue-50 text-right border border-blue-200 rounded-md p-3 mb-4">
            <p className="text-sm text-blue-700">
              ...
              شما فقط می‌توانید با کلاس‌هایی که به عنوان معلم به آنها اختصاص
              داده شده‌اید گفتگو داشته باشید.
            </p>
          </div>
        )}
